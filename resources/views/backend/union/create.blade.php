                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('union.view') }}"> <i
                                                    class="fa fa-list"></i> Union List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ @$editData ? route('union.update', $editData->id) : route('union.store') }}"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name_en">Union Name En</label>
                                            <input id="name_en"
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name_bn">Union Name Bn</label>
                                            <input id="name_bn"
