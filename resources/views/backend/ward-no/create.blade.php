                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('ward-no.view') }}"> <i
                                                    class="fa fa-list"></i> Ward No List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ @$editData ? route('ward-no.update', $editData->id) : route('ward-no.store') }}"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name_en">Ward No En</label>
                                            <input id="name_en"
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name_bn">Ward No Bn</label>
                                            <input id="name_bn"
