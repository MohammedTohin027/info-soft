                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('village.create') }}" class="btn btn-success btn-sm"> <i
                                        ...
                                        @foreach ($allData as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('village.delete', $item->id) }}"
