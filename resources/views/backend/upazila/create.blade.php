                ...
                <div class="row">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('upazila.view') }}"> <i
                                                    class="fa fa-list"></i> Upazila List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ @$editData ? route('upazila.update', $editData->id) : route('upazila.store') }}"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name_en">Upazila Name En</label>
                                            <input id="name_en"
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name_bn">Upazila Name Bn</label>
                                            <input id="name_bn"
